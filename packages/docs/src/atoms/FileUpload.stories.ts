  ...
  render: () => html`
    ...
    <div class="story-container">
      <div class="upload-wrapper">
        <h2 style="margin-bottom: 1.25rem; color: #038450; font-size: 1.5rem;">Subir Archivo - Desktop</h2>
        <p style="margin-bottom: 1.5rem; color: #5b5b5b; font-size: 1.0625rem;">
        ...
        <div class="sb-ui-file-upload">
          ...
          <div class="sb-ui-file-upload-dropzone" style="border: 2px dashed #ccc; border-radius: 12px; padding: 4rem 3rem; text-align: center; background: #fafafa; min-height: 220px;">
            <i class="fa-solid fa-cloud-arrow-up" style="font-size: 4rem; color: #9b9b9b; margin-bottom: 1.25rem;"></i>
            <p style="font-size: 1.25rem; font-weight: 600; color: #1b1b1b; margin-bottom: 0.5rem;">
              Arrastra y suelta aquí
            </p>
            <p style="font-size: 1rem; color: #5b5b5b; margin-bottom: 0.25rem;">
              Formatos: PDF, DOC, DOCX, JPG, PNG
            </p>
            <p style="font-size: 0.9375rem; color: #5b5b5b;">
...
export const Mobile: Story = {
  render: () => html`
    ...
    <div class="story-container">
      <div class="upload-wrapper">
        <h3 style="margin-bottom: 1rem; color: #038450; font-size: 1.375rem;">Subir Archivo</h3>
        <p style="margin-bottom: 1.25rem; color: #5b5b5b; font-size: 1rem;">
        ...
        <div class="sb-ui-file-upload">
          ...
          <div class="sb-ui-file-upload-dropzone" style="border: 2px dashed #ccc; border-radius: 12px; padding: 3rem 1.5rem; text-align: center; background: #fafafa; min-height: 180px;">
            <i class="fa-solid fa-cloud-arrow-up" style="font-size: 3.25rem; color: #9b9b9b; margin-bottom: 1rem;"></i>
            <p style="font-size: 1.125rem; font-weight: 600; color: #1b1b1b; margin-bottom: 0.5rem;">
              Toca para subir
            </p>
            <p style="font-size: 0.9375rem; color: #5b5b5b; margin-bottom: 0.25rem;">
              PDF, DOC, JPG, PNG
            </p>
...
export const Uploading: Story = {
  render: () => html`
    ...
    <div class="story-container">
      <div class="upload-wrapper">
        <h2 style="margin-bottom: 1.25rem; color: #038450; font-size: 1.5rem;">Subiendo Archivo...</h2>
        <p style="margin-bottom: 1.5rem; color: #5b5b5b; font-size: 1.0625rem;">
          Por favor espera mientras se carga tu archivo
        </p>

        <div class="sb-ui-file-upload sb-ui-file-upload--uploading" style="border: 2px solid #e1e1e1; border-radius: 12px; padding: 2rem; background: #f2f9f6;">
          <div style="display: flex; align-items: center; gap: 1.25rem;">
            <i class="fa-solid fa-spinner fa-spin" style="font-size: 2.5rem; color: #038450;"></i>
            <div style="flex: 1;">
              <p style="font-weight: 600; font-size: 1.125rem; color: #1b1b1b; margin-bottom: 0.25rem;">
                documento.pdf
              </p>
              <p style="font-size: 1rem; color: #5b5b5b;">
                Subiendo... 45%
              </p>
            </div>
          </div>
          <div style="width: 100%; height: 8px; background: #e1e1e1; border-radius: 4px; margin-top: 1.25rem; overflow: hidden;">
            <div style="width: 45%; height: 100%; background: linear-gradient(90deg, #038450, #04a65c); border-radius: 4px;"></div>
          </div>
        </div>
      </div>
    </div>
...
export const Success: Story = {
  render: () => html`
    ...
    <div class="story-container">
      <div class="upload-wrapper">
        <h2 style="margin-bottom: 1.25rem; color: #038450; font-size: 1.5rem;">¡Archivo Cargado Exitosamente!</h2>
        <p style="margin-bottom: 1.5rem; color: #5b5b5b; font-size: 1.0625rem;">
          Tu archivo se ha subido correctamente
        </p>

        <div class="sb-ui-file-upload sb-ui-file-upload--success" style="border: 2px solid #038450; border-radius: 12px; padding: 2rem; background: #f2f9f6;">
          <div style="display: flex; align-items: center; gap: 1.25rem; justify-content: space-between;">
            <div style="display: flex; align-items: center; gap: 1.25rem;">
              <i class="fa-solid fa-circle-check" style="font-size: 2.5rem; color: #038450;"></i>
              <div>
                <p style="font-weight: 600; font-size: 1.125rem; color: #1b1b1b; margin-bottom: 0.25rem;">
                  documento.pdf
                </p>
            ...
            <button class="sb-ui-button sb-ui-button--tertiary sb-ui-button--icon-only" style="border: none; background: transparent;">
              <i class="fa-solid fa-xmark" style="font-size: 1.5rem; color: #757575;"></i>
            </button>
          </div>
        </div>
      </div>
...
export const Error: Story = {
  render: () => html`
    ...
    <div class="story-container">
      <div class="upload-wrapper">
        <h2 style="margin-bottom: 1.25rem; color: #E63757; font-size: 1.5rem;">Error al Cargar Archivo</h2>
        <p style="margin-bottom: 1.5rem; color: #5b5b5b; font-size: 1.0625rem;">
          Ha ocurrido un error durante la carga
        </p>

        <div class="sb-ui-file-upload sb-ui-file-upload--error" style="border: 2px solid #E63757; border-radius: 12px; padding: 2rem; background: #FEF5F6;">
          <div style="display: flex; align-items: center; gap: 1.25rem; justify-content: space-between;">
            <div style="display: flex; align-items: center; gap: 1.25rem;">
              <i class="fa-solid fa-circle-xmark" style="font-size: 2.5rem; color: #E63757;"></i>
              <div>
                <p style="font-weight: 600; font-size: 1.125rem; color: #1b1b1b; margin-bottom: 0.25rem;">
                  documento.pdf
                </p>
                <p style="font-size: 1rem; color: #E63757;">
                  El archivo excede el tamaño máximo permitido
                </p>
              </div>
            </div>
            <button class="sb-ui-button sb-ui-button--primary sb-ui-button--text" style="color: #E63757; font-size: 1rem;">
              Reintentar
            </button>
          </div>
        </div>
