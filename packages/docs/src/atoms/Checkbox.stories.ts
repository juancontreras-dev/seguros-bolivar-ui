 ...
 * | **Tamaños** | | |
 * | Pequeño (16px) | `.sb-ui-checkbox--small` | `<label class="sb-ui-checkbox sb-ui-checkbox--small">...</label>` |
 ...
 * ## 💡 Notas Importantes
 *
 * - **Clase única**: Solo usa `.sb-ui-checkbox` - NO hay variantes primary/secondary/tertiary
 * - **Error como estado**: El estado error se maneja con `.sb-ui-checkbox--error`
 * - **Tamaño por defecto**: MEDIUM (20x20px) - no necesitas especificar la clase
 * - **Área de clic amplia**: El label envuelve todo, permitiendo clic en checkbox o texto
 ...
 * - **Focus visible**: Halo verde claro (#E5F4EE) en navegación por teclado
 ...
 *
 * - **Hover**: Halo verde claro (#F2F9F6, 32x32px, opacity 0.7) detrás del checkbox
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Componente de checkbox versátil con estados completos (normal, error, disabled, focus, indeterminate), 3 tamaños, efectos hover/pressed Material Design y accesibilidad nativa.',
      },
    },
  },
  argTypes: {
    ...
    error: {
      control: 'boolean',
      description: 'Estado de error (validación fallida)',
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: false },
      },
 ...
 * en el panel inferior. Puedes ajustar tamaño, estados (checked, disabled, error, indeterminate) y modificadores.
 */
 ...
 *
 * Cada combinación incluye estados interactivos: Default, Hover, Pressed, Focus
 */
 ...
 * - **Large**: 24×24px (para interfaces táctiles o énfasis)
 */
...
/**
 * ## Estado Error - Validación de Formularios
 *
 ...
 *
 * Los halos NO aparecen cuando el checkbox está disabled.
 */
...
/**
 * ## Validación de Formulario - Demo Interactivo
 *
 * Ejemplo real de validación de formulario con checkbox obligatorio.
 * Muestra cómo aplicar dinámicamente el estado error cuando la validación falla.
 */
 ...
 * - **Configuración**: Toggle de settings
 */
