import{x as l}from"./lit-element-BQ2u6o3f.js";const C={title:"Atoms/Select",tags:["autodocs"],parameters:{docs:{description:{component:"Componente de select versátil con soporte para selección simple/múltiple, grupos de opciones y diferentes estados de validación."}}},argTypes:{state:{control:"select",options:["normal","error","success","warning"],description:"Estado de validación del select",table:{type:{summary:"string"},defaultValue:{summary:"normal"}}},size:{control:"select",options:["small","medium","large"],description:"Tamaño del select",table:{type:{summary:"string"},defaultValue:{summary:"medium"}}},label:{control:"text",description:"Texto del label",table:{type:{summary:"string"}}},required:{control:"boolean",description:"Campo requerido",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},disabled:{control:"boolean",description:"Select deshabilitado",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},multiple:{control:"boolean",description:"Selección múltiple",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},helperText:{control:"text",description:"Texto de ayuda",table:{type:{summary:"string"}}},rounded:{control:"boolean",description:"Bordes redondeados",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},hasIcon:{control:"boolean",description:"Incluir icono",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}}}},s={args:{state:"normal",size:"medium",label:"Selecciona una opción",required:!1,disabled:!1,multiple:!1,helperText:"Elige la opción que mejor se adapte a tus necesidades",rounded:!1,hasIcon:!1},render:e=>{const t=["sb-ui-select",e.state!=="normal"?`sb-ui-select--${e.state}`:"",e.size!=="medium"?`sb-ui-select--${e.size}`:"",e.rounded?"sb-ui-select--rounded":"",e.hasIcon?"sb-ui-select--with-icon-left":""].filter(Boolean).join(" "),F=["sb-ui-select-label",e.required?"sb-ui-select-label--required":""].filter(Boolean).join(" "),O=["sb-ui-select-helper",e.state!=="normal"?`sb-ui-select-helper--${e.state}`:""].filter(Boolean).join(" "),i="playground-select";return l`
      <div style="max-width: 400px;">
        <div>
          ${e.label?l` <label class="${F}" for="${i}"> ${e.label} </label> `:""}
          ${e.hasIcon?l`
              ...
              `}
          ${e.helperText?l` <div class="${O}">${e.helperText}</div> `:""}
        </div>
      </div>
    `}},a={render:()=>l`
    <link
  ...
  `};var c,o,r,p,d;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    state: 'normal',
    size: 'medium',
  ...
  render: args => {
    const selectClasses = ['sb-ui-select', args.state !== 'normal' ? \`sb-ui-select--\${args.state}\` : '', args.size !== 'medium' ? \`sb-ui-select--\${args.size}\` : '', args.rounded ? 'sb-ui-select--rounded' : '', args.hasIcon ? 'sb-ui-select--with-icon-left' : ''].filter(Boolean).join(' ');
    const labelClasses = ['sb-ui-select-label', args.required ? 'sb-ui-select-label--required' : ''].filter(Boolean).join(' ');
    const helperClasses = ['sb-ui-select-helper', args.state !== 'normal' ? \`sb-ui-select-helper--\${args.state}\` : ''].filter(Boolean).join(' ');
    const selectId = 'playground-select';
    return html\`
      <div style="max-width: 400px;">
        <div>
          \${args.label ? html\` <label class="\${labelClasses}" for="\${selectId}"> \${args.label} </label> \` : ''}
          \${args.hasIcon ? html\`
                <div class="sb-ui-select-container">
                  <select
                    id="\${selectId}"
...
}`,...(r=(o=s.parameters)==null?void 0:o.docs)==null?void 0:r.source},description:{story:`## Playground (Interactivo)

Experimenta con todas las combinaciones del select usando los controles interactivos
en el panel inferior. Puedes ajustar estado, tamaño, opciones y más.`,...(d=(p=s.parameters)==null?void 0:p.docs)==null?void 0:d.description}}};var b,u,v,m,f;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => html\`
    <link
      rel="stylesheet"
      href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"
  ...
  \`
}`,...(v=(u=a.parameters)==null?void 0:u.docs)==null?void 0:v.source},description:{story:`## Estados - Matriz Completa de Combinaciones
...
**Total: 36 combinaciones** (4 × 3 × 3)`,...(f=(m=a.parameters)==null?void 0:m.docs)==null?void 0:f.description}}};var x,h,g,S,y;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => html\`
    <link
      rel="stylesheet"
      href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"
  ...
  \`
}`,...(g=(h=n.parameters)==null?void 0:h.docs)==null?void 0:g.source},description:{story:`## Características Especiales - Select

Muestra características adicionales del select: múltiple, grupos, requerido, con iconos, etc.`,...(y=(S=n.parameters)==null?void 0:S.docs)==null?void 0:y.description}}};const D=["Playground","Estados","CaracteristicasEspeciales"];export{n as CaracteristicasEspeciales,a as Estados,s as Playground,D as __namedExportsOrder,C as default};
