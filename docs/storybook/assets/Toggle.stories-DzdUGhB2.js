import{x as e}from"./lit-element-BQ2u6o3f.js";const h={title:"Atoms/Toggle",tags:["autodocs"],parameters:{docs:{description:{component:"Componente de toggle/switch versátil con diferentes estilos (switch, button, checkbox), animaciones y estados de validación."}}},argTypes:{state:{control:"select",options:["normal","error","success","warning"],description:"Estado de validación del toggle",table:{type:{summary:"string"},defaultValue:{summary:"normal"}}},size:{control:"select",options:["small","medium","large"],description:"Tamaño del toggle",table:{type:{summary:"string"},defaultValue:{summary:"medium"}}},style:{control:"select",options:["switch","button","checkbox"],description:"Estilo visual del toggle",table:{type:{summary:"string"},defaultValue:{summary:"switch"}}},label:{control:"text",description:"Texto del label",table:{type:{summary:"string"}}},checked:{control:"boolean",description:"Estado marcado/desmarcado",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},required:{control:"boolean",description:"Campo requerido",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},disabled:{control:"boolean",description:"Toggle deshabilitado",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},helperText:{control:"text",description:"Texto de ayuda",table:{type:{summary:"string"}}},rounded:{control:"boolean",description:"Bordes redondeados",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},minimal:{control:"boolean",description:"Estilo minimal",table:{type:{summary:"boolean"},defaultValue:{summary:!1}}},animation:{control:"select",options:["none","bounce","pulse"],description:"Tipo de animación",table:{type:{summary:"string"},defaultValue:{summary:"none"}}}}},l={args:{state:"normal",size:"medium",style:"switch",label:"Activar notificaciones",checked:!1,required:!1,disabled:!1,helperText:"Recibe notificaciones cuando alguien te mencione",rounded:!1,minimal:!1,animation:"none"},render:s=>{const r=["sb-ui-toggle",s.state!=="normal"?`sb-ui-toggle--${s.state}`:"",s.size!=="medium"?`sb-ui-toggle--${s.size}`:"",s.style!=="switch"?`sb-ui-toggle--${s.style}`:"",s.rounded?"sb-ui-toggle--rounded":"",s.minimal?"sb-ui-toggle--minimal":"",s.animation!=="none"?`sb-ui-toggle--${s.animation}`:""].filter(Boolean).join(" "),m=["sb-ui-toggle-helper",s.state!=="normal"?`sb-ui-toggle-helper--${s.state}`:""].filter(Boolean).join(" ");return e`
        ...
        <div class="sb-ui-toggle-container">
          <label class="${r}">
            <input
              ...
              ?disabled="${s.disabled}"
            />
            ${s.style==="button"?e` <span class="sb-ui-toggle-slider"></span> `:e`
                  <span class="sb-ui-toggle-slider"></span>
                  ${s.label&&s.style!=="button"?e` <span class="sb-ui-toggle-label">${s.label}</span> `:""}
                `}
          </label>

          ${s.helperText?e` <div class="${m}">${s.helperText}</div> `:""}
        </div>
      </div>
    `}},a={render:()=>e`
    <style>
  ...
  `};var i,n,t,o,g;l.parameters={...l.parameters,docs:{...(i=l.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    state: 'normal',
    size: 'medium',
    style: 'switch',
  ...
  render: args => {
    const toggleClasses = ['sb-ui-toggle', args.state !== 'normal' ? \`sb-ui-toggle--\${args.state}\` : '', args.size !== 'medium' ? \`sb-ui-toggle--\${args.size}\` : '', args.style !== 'switch' ? \`sb-ui-toggle--\${args.style}\` : '', args.rounded ? 'sb-ui-toggle--rounded' : '', args.minimal ? 'sb-ui-toggle--minimal' : '', args.animation !== 'none' ? \`sb-ui-toggle--\${args.animation}\` : ''].filter(Boolean).join(' ');
    const helperClasses = ['sb-ui-toggle-helper', args.state !== 'normal' ? \`sb-ui-toggle-helper--\${args.state}\` : ''].filter(Boolean).join(' ');
    return html\`
      <div style="max-width: 400px;">
        <div class="sb-ui-toggle-container">
          <label class="\${toggleClasses}">
            ...
            />
            \${args.style === 'button' ? html\` <span class="sb-ui-toggle-slider"></span> \` : html\`
                  <span class="sb-ui-toggle-slider"></span>
                  \${args.label && args.style !== 'button' ? html\` <span class="sb-ui-toggle-label">\${args.label}</span> \` : ''}
                \`}
          </label>
...
}`,...(t=(n=l.parameters)==null?void 0:n.docs)==null?void 0:t.source},description:{story:`## Playground (Interactivo)

Experimenta con todas las combinaciones del toggle usando los controles interactivos
en el panel inferior. Puedes ajustar estilo, estado, tamaño, animaciones y más.`,...(g=(o=l.parameters)==null?void 0:o.docs)==null?void 0:g.description}}};var c,b,u,p,d;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => html\`
    <style>
      .toggle-matrix {
        font-family: var(--sb-ui-typography-fontFamily, 'Roboto', sans-serif);
  ...
  \`
}`,...(u=(b=a.parameters)==null?void 0:b.docs)==null?void 0:u.source},description:{story:`## Estados - Matriz de Combinaciones

Matriz del toggle mostrando combinaciones de:
- **4 Estados**: Normal, Error, Success, Warning
- **3 Tamaños**: Small, Medium, Large
- **3 Estilos**: Switch, Button, Checkbox`,...(d=(p=a.parameters)==null?void 0:p.docs)==null?void 0:d.description}}};const y=["Playground","Estados"];export{a as Estados,l as Playground,y as __namedExportsOrder,h as default};
