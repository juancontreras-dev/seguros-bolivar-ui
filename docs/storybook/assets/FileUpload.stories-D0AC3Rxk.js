import{x as s}from"./lit-element-BQ2u6o3f.js";const C={title:"Atoms/FileUpload",tags:["autodocs"],parameters:{docs:{description:{component:"Componente de carga de archivos con drag & drop, validación de tipo/tamaño, y múltiples estados visuales (uploading, uploaded, success, error)."}}}},o={render:()=>s`
    <style>
      .story-container {
